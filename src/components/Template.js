...
const Template = ({ title, desc1,desc2, image, formtype, setIsLoggedIn }) => {
  ...
  return (
    <div className='flex w-11/12 justify-between  ax-w-[1160px] py-1 mx-auto gap-x-12 gap-y-0 '>
          <div className='w-11/12 max-w-[450px] '>
              ...
              <div className='flex w-full items-center my-2 gap-x-2'>
                  ...
                  <p className='text-richblack-700 font-medium leading[1.375rem] mt-4'
                  > OR</p>
                  <div className='w-full h-[1px] bg-richblack-700'></div>
              </div>
              <button className='w-full flex justify-center items-center rounded-[8px] font-medium text-richblack-100
              border border-richblack-700 px-[8px] py-[8px] gap-x-2 mt-1'>
